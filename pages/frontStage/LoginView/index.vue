    ...
    <div class="container px-6 py-12">
      <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
        <div class="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Tainan_City_Government_Logo.svg/1280px-Tainan_City_Government_Logo.svg.png"
          ...
          <v-form ref="userInputForm"  v-slot="{ errors }" >
            ...
            <div class="flex justify-between items-center mb-6">
              <div class="form-group form-check">
                ...
                <label class="form-check-label inline-block text-gray-800" for="exampleCheck2">記註我</label>
              </div>
              <a href="#!"
