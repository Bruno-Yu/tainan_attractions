      ...
      " type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        ...
        " to="/" exact-active-class="no-active">
          ...
          <ul class="navbar-nav flex flex-col pl-0 list-style-none ms-auto">
            ...
            <li class="nav-item p-2">
              <NuxtLink class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0"
                to="/frontStage/attractionsView">體驗
              </NuxtLink>
            </li>
            <!-- <li class="nav-item p-2">
            ...
            <li class="nav-item p-2">
              <NuxtLink class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0"
                to="/frontStage/ordersView">訂購
              </NuxtLink>
            </li>
            <li class="nav-item p-2">
              <NuxtLink class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0"
                to="/frontStage/loginView">登入
              </NuxtLink>
            </li>
            <!-- <li class="nav-item p-2">
